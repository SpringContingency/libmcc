...
namespace libmcc {
	typedef uint32_t t_customization_item;

    struct s_player_customization {
        t_customization_item helmet_index; // 0x40
        t_customization_item left_shoulder_index; // 0x44
        t_customization_item right_shoulder_index; // 0x48
        t_customization_item chest_index; // 0x4C
        t_customization_item wrist_index; // 0x50
        t_customization_item utility_index; // 0x54
        t_customization_item arms_index; // 0x58
        t_customization_item legs_index; // 0x5C
        t_customization_item backpack_index; // 0x60
        t_customization_item spartan_body_index; // 0x64
        t_customization_item spartan_armor_effect_index; // 0x68
        t_customization_item knees_index; // 0x6C
        t_customization_item visor_color_index; // 0x70
        t_customization_item elite_helmet_index; // 0x74
        t_customization_item elite_left_shoulder_index; // 0x78
        t_customization_item elite_right_shoulder_index; // 0x7C
        t_customization_item elite_chest_index; // 0x80
        t_customization_item elite_arms_index; // 0x84
        t_customization_item elite_legs_index; // 0x88
        t_customization_item elite_armor_index; // 0x8C
        t_customization_item elite_armor_effect_index; // 0x90
        t_customization_item voice_index; // 0x94
        t_customization_item player_model_primary_color; // 0x98
        t_customization_item player_model_secondary_color; // 0x9C
        t_customization_item player_model_tertiary_color; // 0xA0
        t_customization_item spartan_pose; // 0xA4
        t_customization_item elite_pose; // 0xA8
        struct skin_t { int object; t_customization_item skin; } skins[32]; // 0xAC
    };

	static_assert(sizeof(s_player_customization) == 0x16C);

    inline const char* g_player_customization_item_names[] = {
