...
struct units_definition : objects_definition {
    ...
    __int8 v9[0x54];
    datum_index actor_index;//0x168
    __int8 v10[0x4];
    __int32 unit_flags;
    eTeamAI team; //0x174
    t_Player player_index; //0x178
    __int8 v11[0xA0]; //0x20C?
    datum_index aim_target; //0x21C
    __int8 v12[0x14C];
    float camo_time;
    int64 un;
    ...
    int16 biped_flags;
    __int8 v14[0x42];
    datum_index bump_target; // 1188
    __int8 bump_close;

    // 0x460 int16 biped.flags
...
struct unit_control_definition {
    ...
    const static int16 k_unit_aiming_speeds_count = 0x8000;

    int identifier;
    int16 un;
    int16 weapon_set_identifier;
    char primary_weapon_indices;
    char secondary_weapon_indices;
    int16 grenade_index;
    int16 zoom_level;
    int16 interaction_type;
    int64 action_flags;
